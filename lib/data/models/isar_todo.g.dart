...
const TodoIsarSchema = CollectionSchema(
  ...
  properties: {
    ...
    r'priority': PropertySchema(
      ...
      name: r'priority',
      type: IsarType.byte,
      enumMap: _TodoIsarpriorityEnumValueMap,
    ),
...
TodoIsar _todoIsarDeserialize(
  ...
  object.priority =
      _TodoIsarpriorityValueEnumMap[reader.readByteOrNull(offsets[2])] ??
          Priority.low;
...
P _todoIsarDeserializeProp<P>(
  ...
  switch (propertyId) {
    ...
    case 2:
      return (_TodoIsarpriorityValueEnumMap[reader.readByteOrNull(offset)] ??
          Priority.low) as P;
    case 3:
...
const _TodoIsarpriorityEnumValueMap = {
  'low': 0,
  'medium': 1,
  'high': 2,
};
const _TodoIsarpriorityValueEnumMap = {
  0: Priority.low,
  1: Priority.medium,
  2: Priority.high,
};
...
extension TodoIsarQueryProperty
  ...
  QueryBuilder<TodoIsar, Priority, QQueryOperations> priorityProperty() {
    return QueryBuilder.apply(this, (query) {
